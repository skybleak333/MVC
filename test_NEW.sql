...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 25 2019 г., 05:35
...
(1, 'admin', '8dc44d1366afc69b51acdf9b793df655', '4401a2c7cbd173fa41a481574135a9f3'),
(2, 'root', '63a9f0ea7bb98050796b649e85481845', '1'),
(6, 'count', 'c22e5836fd8e280e9d72d7de33f8a2c1', '8cdb45ed97ddb2bc6013ab151aa80665');
...
(18, 9, 68410, 1, 'dfhfghf', '77878778787', 'admin@admin.com'),
(19, 12, 87412, 2, 'Allad', '787754454', 'skybleak333@gmail.com'),
(20, 11, 13990, 3, 'Allad', '787754454', 'skybleak333@gmail.com'),
(21, 13, 19875, 2, 'Allad', '787754454', 'skybleak333@gmail.com');
...
(8, 'Костюмм', 'Ощутите себя победителем спортивных состязаний в этой куртке с эффектом цветовых блоков. Стильная модель украшена логотипом Tommy Sport', '99932', 'on', '2'),
...
(14, 'Платье', 'Это кружевное платье с лифом асимметричного кроя и поясом, подчеркивающим линию талии, отлично дополнит ваш летний праздничный гардероб', '12345', 'on', '2'),
...
--
ALTER TABLE `img`
  MODIFY `id_img` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `sumilar`
  MODIFY `id_similar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
COMMIT;
